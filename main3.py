...
if ds == 0: # This is KITTI with given p_W_landmarks and keypoints.txt
    ...
    img3= cv2.imread(os.path.join(kitti_path, "05/image_01/000003.png"), cv2.IMREAD_GRAYSCALE)
...
# # Load Kitti p_W_landmarks and keypoints.txt
    ...
    img3= cv2.imread(os.path.join(kitti_path, "05/image_0/000003.png"), cv2.IMREAD_GRAYSCALE)

    # Initialize the continuous operation class
    continuous = Continuous_operation(K)
    keypoints,p_W_landmarks = initialization(img1,img2, continuous)
